...
<div class="container-fluid bg-3 text-center">    
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <img src="resources/images/aboutus1.jpg" class="img-responsive" style="width:100%" alt="Image">
    </div>
    <div class="col-sm-4"> 
      
      <img src="resources/images/aboutus2.jpg" class="img-responsive" style="width:100%" alt="Image">
    </div>
    <div class="col-sm-4"> 
     
      <img src="resources/images/aboutus3.jpg" class="img-responsive" style="width:100%" alt="Image">
    </div>
  </div>
</div>
